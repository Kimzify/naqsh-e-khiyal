...
- Give each poem a **different dastgah**. Used so far: Shur (Hafez 1), Bayat-e Esfahan (Hafez 179), Segah (Hafez 255), Homayoun (Saadi 268), Nava (Saadi 187). Quarter tones are written as, for example, `Ek4 = E4 × 2^(-1/24)`.
